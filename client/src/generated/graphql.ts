 ...
 *
 * To run a mutation, you first call `useCreateUserMutationMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useCreateUserMutationMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useCreateUserMutationMutation({
 *   variables: {
 ...
 * });
 */
export function useCreateUserMutationMutation(options: VueApolloComposable.UseMutationOptions<CreateUserMutationMutation, CreateUserMutationMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<CreateUserMutationMutation, CreateUserMutationMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<CreateUserMutationMutation, CreateUserMutationMutationVariables>(CreateUserMutationDocument, options);
}
