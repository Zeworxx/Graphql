...
export type CreateUserMutationMutation = { __typename?: 'Mutation', createUser?: { __typename?: 'CreateUserResponse', code: number, success: boolean, message: string } | null };
...
export type SignInMutation = { __typename?: 'Mutation', signIn?: { __typename?: 'SignInResponse', token?: string | null, userId?: string | null, code: number, message: string, success: boolean } | null };
...
export type CreateUserMutationMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<CreateUserMutationMutation, CreateUserMutationMutationVariables>;
...
export const GetArticlesQueryDocument = gql`
